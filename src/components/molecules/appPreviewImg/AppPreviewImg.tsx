...
const AppPreviewImg = () => {
    return ( 
        <figure className={styles.appPreviewImg}>
            <img className={styles.mobileScreen} src={mobileScreen} loading="lazy" alt="mobile Screen"/>
            <img className={styles.decorElem3} src={decorElem3} loading="lazy" alt="decorative element" />
        </figure>
     );
}
