...
const HeroInfo = () => {
    return ( 
        <article className={styles.heroInfo}>
            ...
            <div className={styles.itemsGroup}>
                <ButtonTypePrimary onClick={() => console.log("ButtonTypePrimary Click")}><span>Get Started</span></ButtonTypePrimary>
                <ButtonTypeSecondary onClick={() => console.log("ButtonTypeSecondary Click")}><span>Go Pro</span></ButtonTypeSecondary>
            </div>
        </article>
